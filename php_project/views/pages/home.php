            ...
            <div class="tab-class">
                        ...
                        <ul class="nav nav-pills d-inline-flex text-center mb-5">
                            ...
                            <li class="nav-item mb-4">
                                <a class="d-flex py-2 mx-2 bg-light rounded-pill" data-bs-toggle="pill" href="#tab-2">
                                    <span class="text-dark" style="width: 130px;">Offer</span>
                                </a>
                            </li>
                            <li class="nav-item mb-4">
                ...
                <div class="tab-content">
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row g-4">
                            <?php $ourProducts = Products::ourProducts(); 
                                // print_r($ourProducts);
                                ...
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <img src="admin/<?php echo $product['photo']; ?>" class="img-fluid w-100 rounded-top" alt="">
                                            <div class="product-new">New</div>
                                            <div class="product-details">
                                                <a href="product?id=<?php echo $product['id']; ?>"><i class="fa fa-eye fa-1x"></i></a>
                                            </div>
                                        </div>
                                        <div class="text-center rounded-bottom p-4">
                                            <a href="#" class="d-block mb-2"><?php echo $product['category']; ?></a>
                                            <a href="product?id=<?php echo $product['id']; ?>" class="d-block h4"><?php echo $product['name']; ?></a>
                                            <?php if($product['discount'] > 0): ?>
                                                <del class="me-2 fs-5">TK.<?php echo $product['price']; ?></del>
                                            <?php endif; ?>
                                            <span class="text-primary fs-5">TK.<?php echo $product['price'] - $product['discount']; ?></span>
                                        </div>
                                    </div>
                                    <div
                    ...
                    <div id="tab-2" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <?php $offerProducts = Products::offerProducts();
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <img src="admin/<?php echo $product['photo']; ?>" class="img-fluid rounded-top" alt="">
                                            <div class="product-new bg-danger">Sale</div>
                                            <div class="product-details">
                                                <a href="product?id=<?php echo $product['id']; ?>"><i class="fa fa-eye fa-1x"></i></a>
                                            </div>
                                        </div>
                                        <div class="text-center rounded-bottom p-4">
                                            <a href="#" class="d-block mb-2"><?php echo $product['category']; ?></a>
                                            <a href="product?id=<?php echo $product['id']; ?>" class="d-block h4"><?php echo $product['name']; ?></a>
                                            <del class="me-2 fs-5"><?php echo $product['price']; ?></del>
                                            <span class="text-primary fs-5"><?php echo $product['price'] - $product['discount']; ?></span>
                                        </div>
                                    </div>
                                    <div
                                        class="product-item-add border border-top-0 rounded-bottom  text-center p-4 pt-0">
                    ...
                    <div id="tab-3" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <?php $featuredProducts = Products::featuredProducts(); 
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <img src="admin/<?php echo $product['photo']; ?>" class="img-fluid w-100 rounded-top" alt="">
                                            <div class="product-new bg-dark"><small>Featured</small></div>
                                            <div class="product-details">
                                                <a href="product?id=<?php echo $product['id']; ?>"><i class="fa fa-eye fa-1x"></i></a>
                                            </div>
                                        </div>
                    ...
                    <div id="tab-4" class="tab-pane fade show p-0">
                        <div class="row g-4">
                            <?php $bestSellingProducts = Products::bestSellingProducts(); 
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3">
                                <div class="product-item rounded wow fadeInUp" data-wow-delay="0.1s">
                                    <div class="product-item-inner border rounded">
                                        <div class="product-item-inner-item">
                                            <img src="admin/<?php echo $product['photo']; ?>" class="img-fluid w-100 rounded-top" alt="">
                                            <div class="product-new bg-success text-center"><small>Best <br> Selling</small></div>
                                            <div class="product-details">
                                                <a href="product?id=<?php echo $product['id']; ?>"><i class="fa fa-eye fa-1x"></i></a>
                                            </div>
                                        </div>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-8.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-9.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-10.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-12.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-13.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-14.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-15.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                    ...
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-5">
                                <div class="products-mini-img border-end h-100">
                                    <img src="assets/img/product-17.png" class="img-fluid w-100 h-100" alt="Image">
                                    <div class="products-mini-icon rounded-circle bg-primary">
                                        <a href="#"><i class="fa fa-eye fa-1x text-white"></i></a>
                                    </div>
                                </div>
