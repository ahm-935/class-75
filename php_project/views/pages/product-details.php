<?php
if(isset($_GET['id'])) {
    $product = Products::readById($_GET['id']);
    // print_r($Product);
}
?>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-7 col-xl-9 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="row g-4 single-product">
                        <div class="col-xl-6">
                            <img class="img-fluid w-100" src="admin/<?php echo $product['photo'] ?>" alt="<?php echo $product['name'] ?>">
                        </div>
                        <div class="col-xl-6">
                            <h4 class="fw-bold mb-3"><?php echo $product['name'] ?></h4>
                            <p class="mb-3">Category: <?php echo $product['category'] ?></p>
                            <?php if($product['discount'] > 0): ?>
                            <del class="fw-bold mb-1 text-danger">TK. <?php echo $product['price'] ?></del>
                            <?php endif; ?>
                            <h5 class="fw-bold mb-3">TK. <?php echo $product['price']-$product['discount'] ?></h5>
